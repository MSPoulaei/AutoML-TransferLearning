...
def get_dataset_preset(preset_name: str) -> dict:
    ...
    presets = {
        ...
        "stanford_cars": {
            ...
            "image_width": 224,
            "domain": "fine_grained",
            "domain_description": "16,185 images of 196 car classes at the level of make, model, and year, such as 2012 Tesla Model S or 2012 BMW M3 coupe",
            "class_balance": "balanced",
            "data_quality": "high",
        },
        "fgvc_aircraft": {
            ...
            "image_width": 224,
            "domain": "fine_grained",
            "domain_description": "10,000 images of aircraft spanning 100 different aircraft model variants, mostly civil aircraft",
            "class_balance": "balanced",
            "data_quality": "high",
        },
        "imagenet": {
